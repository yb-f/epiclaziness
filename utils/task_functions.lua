...
local task_functions = {
    ADVENTURE_ENTRANCE         = {
        ...
        params = function() return { common_settings.settings, char_settings.SaveState } end,
    ...
    COMBINE_DO                 = {
        func   = inv.combine_do,
        params = function() return { common_settings.settings, char_settings.SaveState, _G.State.combineSlot } end,
    ...
    FARM_RADIUS_EVENT          = {
        func   = _G.Actions.farm_radius,
        params = function() return { common_settings.settings, char_settings.SaveState, true } end,
    ...
    FORWARD_ZONE               = {
        ...
        params = function() return { common_settings.settings, char_settings.SaveState, _G.State:readGroupSelection() } end,
    ...
    GROUP_SIZE_CHECK_WITH_ZONE = {
        ...
        params = { true },
        desc   = function(item)
            return 'Making sure group has at least ' ..
                item.count .. ' players, and that they are within the same zone.'
        end
    },
    IGNORE_MOB                 = {
    ...
    NPC_TRAVEL                 = {
        ...
        params = function() return { common_settings.settings, false, char_settings.SaveState } end,
        desc   = function(item) return 'Move to ' .. item.npc end
    },
    NPC_TRAVEL_NO_PATH_CHECK   = {
        func   = travel.npc_travel,
        params = function() return { common_settings.settings, true, char_settings.SaveState } end,
